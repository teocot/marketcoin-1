...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 XMQ
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 XMQ mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 26000000 * COIN;
...
double GetDifficultyAfterRetarget(unsigned int nBits);
