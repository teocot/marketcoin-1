...
uint256 hashGenesisBlock("0x1ae2d2c9dea37db9a29da7a6e90c7209e3ea14072b635d5881f1b5c5031e8193");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb4c132e5e9a6792ab421dac58660dab47592bb1c86c99ac781b6f9814de282c0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1530000163;
        block.nBits    = 0x1e07ffff;
        block.nNonce   = 2087289764;

        if (fTestNet)
        {
            block.nTime    = 1530000229;
            block.nNonce   = 390060427;
        }
